# Generated by Django 5.0.14 on 2025-07-23 06:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('SAMCSYS', '0214_b1_history'),
    ]

    operations = [
        migrations.CreateModel(
            name='B1_MonthlyArchive',
            fields=[
                ...
                ('AproveDate', models.DateTimeField(blank=True, null=True)),
                ('AmountOfInteresRate', models.FloatField(blank=True, null=True)),
                ('OutOfInterestRate', models.FloatField(blank=True, null=True)),
                ('MonthlyArchive', models.CharField(blank=True, max_length=7, null=True)),
            ],
            options={
